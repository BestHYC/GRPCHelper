...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    /// </summary>
    public static class GrpcSolutionExtensions
    {
        /// <summary>
        ...
        /// </para>
        /// </remarks>
        public static IHttpClientBuilder AddMyGrpcClient<TClient>(this IServiceCollection services, IConfiguration configuration)
            where TClient : class
        {
            if (services == null)
            {
            ...
            String aa = configuration.GetSection("GRPCUrl:Uri").Value;
            services.Configure<GrpcClientFactoryOptions>(options => options.Address = new Uri(aa));
        ...
        /// </para>
        /// </remarks>
        public static IHttpClientBuilder AddMyGrpcClient<TClient>(this IServiceCollection services, Action<GrpcClientFactoryOptions> configureClient)
            where TClient : class
        {
            var name = TypeNameHelper.GetTypeDisplayName(typeof(TClient), fullName: false);

            return services.AddMyGrpcClient<TClient>(name, configureClient);
        }
        ...
        /// </para>
        /// </remarks>
        public static IHttpClientBuilder AddMyGrpcClient<TClient>(this IServiceCollection services, Action<IServiceProvider, GrpcClientFactoryOptions> configureClient)
            where TClient : class
        {
            var name = TypeNameHelper.GetTypeDisplayName(typeof(TClient), fullName: false);
        ...
        /// </para>
        /// </remarks>
        public static IHttpClientBuilder AddMyGrpcClient<TClient>(this IServiceCollection services, string name)
            where TClient : class
        {
            if (services == null)
            {
        ...
        /// </para>
        /// </remarks>
        public static IHttpClientBuilder AddMyGrpcClient<TClient>(this IServiceCollection services, string name, Action<GrpcClientFactoryOptions> configureClient)
            where TClient : class
        {
            if (services == null)
            {
        ...
        /// </para>
        /// </remarks>
        public static IHttpClientBuilder AddMyGrpcClient<TClient>(this IServiceCollection services, string name, Action<IServiceProvider, GrpcClientFactoryOptions> configureClient)
            where TClient : class
        {
            if (services == null)
            {
        ...
        private static IHttpClientBuilder AddGrpcClientCore<TClient>(this IServiceCollection services, string name) where TClient : class
        {
            ...
            services.TryAddSingleton<DefaultClientActivator>();
        ...
        public static TClient CreateClient<TClient>(this GrpcClientFactory factory) where TClient: class
        {
            var name = TypeNameHelper.GetTypeDisplayName(typeof(TClient), fullName: false);
